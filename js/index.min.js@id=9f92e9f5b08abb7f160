...
$(function(){
    ...
    var thanksArray = [
        'Спасибо, что начинаете игру вместе с нами!<br>Ждем Вас на наших серверах.',
        'Рады приветствовать Вас на нашем проекте! Скачивание GTA San Andreas и Multiplayer начнется автоматически. Дальнейшие инструкции на предыдущей странице',
        'Ура! Теперь Ты с нами! Скачивание GTA и клиента уже началось, можешь пока посмотреть дальнейшие инструкции или видео о нас на предыдущей странице!',
    ];
...
let monitoring = {
    ...
    copyToClipboard2: function (promocodes) {
        ...
        if (copyCommandSupported === true) {
            ...
            try {
                let successful = document.execCommand('copy');
                let msg = successful ? 'Промокод успешно скопирован!' : 'Промокод не скопирован!';
                notification.success(msg);
            } catch (err) {
                console.log('Невозможно скопировать!');
            }
